...
%=================================================================
\documentclass[journal,article,submit,pdftex,moreauthors]{sections/mdpi} 
...
\Author{Demetrios Chiuratto Agourkis $^{1}$\orcidA{}, Firstname Lastname $^{2}$ and Firstname Lastname $^{2,}$*}
